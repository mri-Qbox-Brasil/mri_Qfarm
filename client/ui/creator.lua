...
local UiShared = lib.require("client/ui/shared")

local function deleteFarm(args)
    local farm = Defaults.Farms[args.farmKey]
    local result = delete(locale("actions.confirmation_description", locale("actions.farm"), Defaults.Farms[args.farmKey].name), Defaults.Farms, args.farmKey)
    if result then
...
local function deleteItem(args)
    ...
    local result = delete(locale("actions.confirmation_description", locale("actions.item"), itemLabel), Defaults.Farms[args.farmKey].config.items, args.itemKey)
    if result then
        args.callback(
            {
...
local function deletePoint(args)
    local result = delete(locale("actions.confirmation_description", locale("actions.point"), args.name), Defaults.Farms[args.farmKey].config.items[args.itemKey].points, args.pointKey)
    args.callback(
        {
            farmKey = args.farmKey,
            itemKey = args.itemKey
...
local function changeFarmStart(args)
    if UiUtils.confirmationDialog(locale("actions.farm.nostart.alert.description"), locale("actions.farm.nostart.alert.title")) == "confirm" then
...
local function changeFarmAFK(args)
    if UiUtils.confirmationDialog(locale("actions.farm.afk.alert.description"), locale("actions.farm.afk.alert.title")) == "confirm" then
...
local function setFarmGrade(args)
    local key = args.farmKey
    local farm = Defaults.Farms[key]
    local input = UiUtils.numberInputDialog(locale("forms.creator.grade.title"), locale("forms.creator.grade.description", farm.name))
    if input then
...
local function selItemInput(args, extra)
    return UiUtils.itemSelectInput(locale("actions.item.select"), locale("items.description_name"), (extra and (args["extraItemKey"] or "")) or args["itemKey"])
end
...
local function setName(args)
    ...
    local input = UiUtils.textInputDialog(locale("route.setname"), locale("route.name"), locale("route.description"), item["customName"] or Items[args.itemKey].label, 5, 30)
    if input then
        ...
        options = {
            ...
            },
            {
                ...
                description = locale(
                    ...
                    item["collectItem"] and item["collectItem"]["name"] and Items[item["collectItem"]["name"]].label or locale("misc.none"),
            ...
            },
            {
                ...
                description = locale("actions.item.description_gain_stress", item["gainStress"] and (item["gainStress"]["min"]) or 0, item["gainStress"] and (item["gainStress"]["max"]) or 0),
                icon = "face-tired",
                iconAnimation = Config.IconAnimation,
            ...
            },
            {
                ...
                description = locale("actions.item.description_police_alert", item.policeAlert and item.policeAlert.chance or locale("actions.item.global_setting")),
                icon = "bell",
                iconAnimation = Config.IconAnimation,
            ...
            },
            {
                ...
                description = locale("actions.item.description_police_alert_type", item.policeAlert and item.policeAlert.type or locale("actions.item.global_setting")),
            ...
            },
            {
                ...
                icon = "shuffle",
                iconColor = Utils.ifThen(item.randomRoute, Defaults.ColorScheme.success, Defaults.ColorScheme.danger),
                iconAnimation = Config.IconAnimation,
                onSelect = setRandom,
                args = {
                    farmKey = args.farmKey,
            ...
            },
            {
                ...
                icon = "infinity",
                iconAnimation = Config.IconAnimation,
                iconColor = Utils.ifThen(item.unlimited, Defaults.ColorScheme.success, Defaults.ColorScheme.danger),
...
local function itemActionMenu(args)
    ...
    local ctx = {
        id = "action_item",
        title = item["customName"] ~= "" and item["customName"] or Items[args.itemKey].label,
        description = Items[args.itemKey].description,
        menu = "items_farm",
        options = {
            {
            ...
            },
            {
                ...
                description = locale("actions.farm.description_afk", Utils.ifThen(Defaults.Farms[args.farmKey].config.afk, locale("misc.actived"), locale("misc.disabled"))),
                icon = "person-walking",
                iconAnimation = Config.IconAnimation,
            ...
            },
            {
                ...
                description = locale("actions.item.description_debug_points", Utils.ifThen(item.debugPoints, locale("misc.yes"), locale("misc.no"))),
                icon = Utils.ifThen(item.debugPoints, "toggle-on", "toggle-off"),
                iconColor = Utils.ifThen(item.debugPoints, Defaults.ColorScheme.success, Defaults.ColorScheme.danger),
                iconAnimation = Config.IconAnimation,
    ...
    local ctx = {
        ...
        options = {
            ...
            },
            {
                ...
                icon = "bolt",
                iconAnimation = Config.IconAnimation,
                iconColor = Utils.ifThen(farm.config.nostart, Defaults.ColorScheme.success, Defaults.ColorScheme.danger),
            ...
            },
            {
                ...
                description = locale("actions.farm.description_police_alert", Utils.ifThen(farm.config.policeAlert and farm.config.policeAlert.enabled, locale("misc.yes"), locale("misc.no"))),
                icon = "bell",
                iconAnimation = Config.IconAnimation,
...
local function manageFarms()
    ...
    local ctx = {
        ...
        options = {
            ...
            {
                title = locale("actions.config"),
                description = locale("actions.description_config"),
                icon = "gear",
                iconAnimation = Config.IconAnimation,
                arrow = true,
                onSelect = configGeneral
            }
        }
    }
    lib.registerContext(ctx)
